    ...
    for row in ws.iter_rows(min_row=2, max_col=10):
        ...
        if row[9].value == "Метка 13":
            ...
            if isinstance(row[7].value, (int, float)):
                ...
                # Если значение не числовое, игнорируем его или выполняем другое действие
                pass
...
print(file_opener("C:/Users/syankovskiy/PycharmProjects/collectioncoin_bot/users_files/32693_.xlsx"))